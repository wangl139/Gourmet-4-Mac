...
export default function SearchBar() {
  ...
  return (
    <div>
      <div className="subsubgroup1">
	  <InputGroup className="changeRadius">
        <input class="form-control form-control-lg" type="text" placeholder="What do you want to eat today?"  onChange={(e) => onChangeInput(e.target.value)} />                    
